...
<body>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="./images/clothes2.jpg" alt="Chicago">
    </div>
    <div class="carousel-item">
...
<!--gird--><!--Right side-->
				<figure>
				<div class="col-sm-5">
					<a href="mens-products.php"><img class="center img-responsive" src="./images/mens.jpg"></a>
					<div class="carousel-caption">
					<h6 class="display-2">Mens</h6>
				</div>
				</div>
			</figure>
					<figure>
				<div class="col-sm-6">
					<a href="womens-products.php"><img class="center img-responsive" src="./images/womens.jpg" ></a>
					<div class="carousel-caption">
					<h6 class="display-2">Womens</h6>
				</div>
			</div>
		</figure>
